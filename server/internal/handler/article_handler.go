...
func (h *ArticleHandler) GetByID(c *gin.Context) {
	...
	if article == nil {
		utils.Error(c, http.StatusNotFound, utils.CodeArticleNotFound)
		return
	}
...
func (h *ArticleHandler) CreateComment(c *gin.Context) {
	...
	c.JSON(http.StatusCreated, utils.NewResponse(utils.CodeSuccess, comment))
}
...
func (h *ArticleHandler) ToggleLike(c *gin.Context) {
	...
	utils.Success(c, gin.H{"isLiked": isLiked, "articleId": id})
}
...
func (h *ArticleHandler) ToggleFavorite(c *gin.Context) {
	...
	utils.Success(c, gin.H{"isFavorited": isFavorited, "articleId": articleID})
}
