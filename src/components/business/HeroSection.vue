<template>
  <section class="relative w-full pt-16" :style="sectionStyle">
    <!-- Background Image -->
    <img
      :src="backgroundImage"
      :alt="backgroundAlt"
...
const heroData = {
  nexus: {
    backgroundImage: '/images/image_0_yi19x4.jpg',
    backgroundAlt: 'Cyberpunk cityscape with neon lights and futuristic technology',
    heroTitle: 'NEXUS DAILY',
    heroSubtitle: '今日情报已更新 // DAILY INTEL UPDATED',
    hudText: '// SYSTEM ONLINE',
    primaryButtonText: '开始探索',
    secondaryButtonText: '查看任务',
    primaryIcon: Compass,
    secondaryIcon: ScrollText,
    showScanline: true
  },
  comiket: {
    backgroundImage: '/images/image_2_yi19x4.jpg',
    backgroundAlt: '动漫科技特集',
    heroTitle: '最新科技 x 热门游戏',
    heroSubtitle: '一网打尽！每天精选最前沿的科技资讯和最热门的动漫游戏情报',
    hudText: '今日特集',
    primaryButtonText: '开始阅读',
    secondaryButtonText: '浏览漫画',
    primaryIcon: Compass,
    secondaryIcon: ScrollText,
    showScanline: false
  },
  ironcore: {
    backgroundImage: '/images/image_4_yi19x4.jpg',
    backgroundAlt: 'Mecha cockpit interior',
    heroTitle: 'IRONCORE DAILY',
    heroSubtitle: '情报已同步 // INTELLIGENCE SYNCHRONIZED',
    hudText: 'SYSTEM ONLINE // INTEL FEED ACTIVE',
    primaryButtonText: 'ACCESS INTEL',
    secondaryButtonText: 'VIEW BRIEFING',
    primaryIcon: Radar,
...
const currentHeroData = computed(() => heroData[themeStore.currentTheme])

const backgroundImage = computed(() => currentHeroData.value.backgroundImage)
const backgroundAlt = computed(() => currentHeroData.value.backgroundAlt)
const heroTitle = computed(() => currentHeroData.value.heroTitle)
const heroSubtitle = computed(() => currentHeroData.value.heroSubtitle)
const hudText = computed(() => currentHeroData.value.hudText)
const primaryButtonText = computed(() => currentHeroData.value.primaryButtonText)
const secondaryButtonText = computed(() => currentHeroData.value.secondaryButtonText)
const primaryIcon = computed(() => currentHeroData.value.primaryIcon)
const secondaryIcon = computed(() => currentHeroData.value.secondaryIcon)
const showScanline = computed(() => currentHeroData.value.showScanline)
