...
const (
	// Label holds the string label denoting the articleread type in the database.
	Label = "article_read"
	...
	FieldReadAt = "read_at"
	// Table holds the table name of the articleread in the database.
	Table = "article_reads"
)

// Columns holds all SQL columns for articleread fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
var (
	...
	DefaultReadAt func() int64
	// DefaultID holds the default value on creation for the "id" field.
	DefaultID func() string
)

// OrderOption defines the ordering options for the ArticleRead queries.
