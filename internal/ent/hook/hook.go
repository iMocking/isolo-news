...
// The ArticleReadFunc type is an adapter to allow the use of ordinary
// function as ArticleRead mutator.
type ArticleReadFunc func(context.Context, *ent.ArticleReadMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ArticleReadFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ArticleReadMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ArticleReadMutation", m)
}
...
// The ScheduleSettingFunc type is an adapter to allow the use of ordinary
// function as ScheduleSetting mutator.
type ScheduleSettingFunc func(context.Context, *ent.ScheduleSettingMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ScheduleSettingFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ScheduleSettingMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ScheduleSettingMutation", m)
}
...
// The UserQuestFunc type is an adapter to allow the use of ordinary
// function as UserQuest mutator.
type UserQuestFunc func(context.Context, *ent.UserQuestMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f UserQuestFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.UserQuestMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.UserQuestMutation", m)
}
